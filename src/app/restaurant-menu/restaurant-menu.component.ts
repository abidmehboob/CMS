...
@Component({
  ...
  styleUrls: ['./restaurant-menu.component.css','../subadmin-detail/subadmin-detail.component.css']
})
export class RestaurantMenuComponent implements OnInit {
  ...
  constructor(
    ...
    private notifyService: NotificationService) {
      ...
      this.subscriptions[0] = this.activatedRoute.paramMap.subscribe(params => { 
        ...
        this.resName = params.get('name')
        this.restaurantService.getRestaurantAllMenus(id)
        this.subscriptions[1] = this.restaurantService.menus$.subscribe(data => {
  ...
  ngOnDestroy(){
    ...
    this.restaurantService.menus$.next(null)
  }
